...
## Task 1：主題狀態管理（Context + Hook）✅ 完成（commit f3647c2..4021d72，review clean）
...
## Task 2：Tailwind class-based dark variant 設定 ✅ 完成（commit 4021d72..4256365，review clean）
...
## Task 3：ThemeToggle 元件 + Toolbar 整合 ✅ 完成（commit 4256365..9e6121e，review clean）
...
## Task 4：全站套用 dark: 樣式（Board 主頁）✅ 完成（commit 9e6121e..c95eb7e，review clean）
...
## Task 5：全站套用 dark: 樣式（List / Gantt / 已完成頁 / Drawer / 其他彈出元件）✅ 完成（commit c95eb7e..1d70445，review clean；已知限制：Markdown 預覽 code block/table 因缺 @tailwindcss/typography 無框線樣式，pre-existing 非本次迴歸）
- 補上 `dark:` 變體：
  - `ListView.tsx`
  - `GanttView.tsx`
  - `DonePage.tsx`
...
## Task 6：README 更新 + 最終整支分支 review ✅ 完成（commit 57f2734）
